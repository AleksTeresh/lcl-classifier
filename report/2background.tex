...
are bounded by a constant. That is a degree of each node is
...
In this subsection I will formalise LOCAL model that I informally described above.
...
worth noting that there exists two kinds of randomized algorithms: ``Monte Carlo'' and
...
When saying that a certain randomised algorithm ``solves'' a certain problem in
...
where objects of certain type, which possibly share some
...
automated problem classifications have led to succesfull
...
\section{Recent developments in automated classification of LCL problems}
...
classify at least \emph{some} of the randomized binary labelling
...
provide a freely available open source software that is able to
