...
from other models of distributed computing, namely unique identifiers and arbitraryly large
bandwidth.
...
the identifiers of the node are not necessarily from a continuous range of integers. That is
...
and what has not beem, with the exception of only one integer - their own identifier.
