...
computation, we are concerned with a number of interconnected computing entities
...
between each other. Apart from senting infromation to each other, nodes can also
do local computation based on the local information each nodes posesses. One thing
to note that differs significantly from some of the centralised models of computation
is that each vertex in a graph has unlimited storage and computation resources.
...
Furthermore, the nodes in a graph act in a synchronous manner.
