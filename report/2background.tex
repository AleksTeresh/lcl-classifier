...
for understanding the content of the thesis. First, we will define paths and cycles.
...
But before we define what it means to solve a problem in a randomised setting, it is
