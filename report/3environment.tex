...
the methods described can just as well be applied to cases of higher degrees, but it unclear
how practical it would be both in terms of time it will require to classify a single problem
and in terms of how many problems of higher degrees will actaully be tightly classified. Secondly,
even in the case when $\dela = 3$ and $\sigma = 2$, 106 non-isomorphic problems have not been
classified tighly, or inn oher words there are 106 problems with non-matching lower and uppper bounds.
