...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Automated classification of LCL \mbox{problems}}
...
round eliminator, classification of LCLs, graph algorithms}
...
for invaluable feedback and advice he provided during the process of writing
the thesis. Besides, I would like to thank Sebastian Brandt,
Juho Hirvonen, Jan Studený, and Dennis Olivetti for offering their
...
FIXME: add publication forums to all the references in the list
\end{document}
