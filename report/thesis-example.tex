...
\newcommand{\KEYWORDS}{distributed algorithms, distributed computing, locally checkable problems,
...
is a well-established and quickly-developed area of theoretical computer
...
complexity landscape of locally checkable problems (LCLs),
which is one of the most significant and well-studied
families of problems in distributed computing.
...
to be practical in nature, and were subsequently
implemented as computer programs that can tell
something useful about complexities of LCL problems.

But the problem is that these meta-algorithms are not
...
which makes it inconvinient to use them in everyday work.
...
And although we failed to accomplish the goal in its entirety,
we did develop a unified system that encapsulates most of the
existing meta-algorithms, providing a unified interface to its users.
Besides, we also implemented a Web interface, to make the tool even more
accessible for the community. Finally, we critically analyse the
