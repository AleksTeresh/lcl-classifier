...
\begin{table}
  \centering
  \newcommand{\mysp}{4.0mm}
  \newcommand{\mys}{1.8mm}
  \newcommand{\myss}{0.9mm}
  \newcommand{\mysl}{2mm}
...
To evaluate how well I have done, we can refer to Table~\ref{table:summary}. The table shows which families of LCL problems on trees, paths, and cycles are decidable and which are not. It also gives further details about the decidability of the families. For instance, it shows whether all complexity classes are decidable for a particular problem family or only some.
...
In this section, we will evaluate my implementation from a
