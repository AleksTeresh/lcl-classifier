...
Finding out complexity of a specific problem take consistently under
...
% the performance results with the precision down to a second.
...
% virtual instance the software is currently deployed to.

% Finally, when presenting results for classyfing a problem or
% performing a query, we measure the time it takes
% from the moment of pressing a button in the Web user interface
% to the moment the results are displayed. Therefore, the time
% includes factors like network delay as well as executing code
% on the front end. We decided to measure it this way since
% this is how most of the users are going to use the tool.

% \subsection{Classifying a problems}
...
% \subsection{Batch classification}
