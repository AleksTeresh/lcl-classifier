export const readyQueries = [
  ...
  },
  {
    ...
    linkText: 'All 3-label problems on (3, 2)-biregular unrooted trees',
    afterText: ''
  },
  {
    ...
    linkText: '3-label problems on (3, 2)-biregular unrooted trees with complexity Theta(log* n)',
  ...
  },
  {
    ...
    linkText: 'Smallest unclassified problem among 3-label problems on (3, 2)-biregular unrooted trees',
    afterText: ''
  },
  {
    ...
    linkText: 'All Theta(log* n)-solvable among 4-label problems on (3, 2)-biregular rooted trees, where active nodes use monochromatic configs only',
  ...
  },
  {
    ...
    linkText: 'Unclassified 4-label problems on (3, 2)-biregular rooted trees',
